...
4. [Public transport isohrones notebook](https://github.com/skaryaeva/urban_studies_notebooks/blob/master/public_transport_api.ipynb) works with [HERE public transport API](https://developer.here.com/documentation/examples/rest/public_transit/isochrone-search), receiving list of stations with coordinates and minutes spent to reach it, and then goes to [HERE isoline API](https://developer.here.com/documentation/routing/dev_guide/topics/resource-calculate-isoline.html) for calculating pedestrian isolines for the rest of given time, thus drawing a public transport isohrone.

5. [Overpass notebook](https://github.com/skaryaeva/urban_studies_notebooks/blob/master/osm_python_tools.ipynb) using [OSMPythonTools library](https://github.com/mocnik-science/osm-python-tools), retrieves OSM POI with coordinates according to given list of types within bounding box
